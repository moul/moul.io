...
<html>
    <head>
        <meta name="go-import" content="moul.io/$package git $clone">
        <meta name="go-source" content="moul.io/$package $doc $doc/tree/master{/dir} $doc/tree/master{/dir}/{file}#L{line}">
